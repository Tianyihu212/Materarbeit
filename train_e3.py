...
from engine import train_one_epoch, evaluate, train_one_epoch_contra, test_retrieval, train_one_epoch_contra_only
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_e4-2',
...
def main(args):
    ...
    sampler = WeightedRandomSampler(weights=train_sample_list, num_samples=160000, replacement=False)
...
#         train_stats = train_one_epoch_contra_only(
#             model, criterion,  criterion_contra, train_dataloader,
#             optimizer, epoch, args.epochs
#         )
