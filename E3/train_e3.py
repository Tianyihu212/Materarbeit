...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_e3',
                        help='path where to save, empty for no saving')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--epochs', default=50, type=int)
    parser.add_argument('--resume', default=False)
    parser.add_argument('--model_path', default='output_e3/checkpoint_e21_68.58914419869241.pth')
    return parser
...
def main(args):
    ...
    test_dataset = GLDDataset(root='../DATA/test_1k_final/test_1k_final', input_size=224, subset='test')
    ...
    sampler = WeightedRandomSampler(weights=train_sample_list, num_samples=1300000, replacement=False)
